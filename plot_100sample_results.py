#!/usr/bin/env python3
"""
Plot the 100-sample steering results with style matching fig_direction_summary.pdf
"""
...
# ============================================================================
# FIGURE 1: Log-scale individual plots (6 subplots)
# ============================================================================
...
# ============================================================================
# FIGURE 2: Summary with style matching fig_direction_summary.pdf
# ============================================================================
...
# ============================================================================
# Panel (A): All layers overlaid with uncertainty
# ============================================================================
# Color palette matching fig_direction_summary.pdf style
...
ax0.set_title("(A) Steering Response by Layer", fontsize=11, fontweight="bold")
ax0.legend(fontsize=8, loc="best", ncol=2)
ax0.grid(True, alpha=0.3)

# ============================================================================
# Panel (B): Effect magnitudes as bar chart
# ============================================================================
...
ax1.set_ylabel("Effect Size (Δ preference)", fontsize=11)
ax1.set_title("(B) Causal Effect Strength", fontsize=11, fontweight="bold")
...
# Main title
fig.suptitle(
    f"Direction Steering: Causal Intervention (Real code, n={results['n_samples']})",
    fontsize=12,
    fontweight="bold",
    y=1.02,
)
