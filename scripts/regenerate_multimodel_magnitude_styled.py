#!/usr/bin/env python3
"""
Regenerate multimodel magnitude comparison with fig_direction_alignment.pdf style.
...
def generate_magnitude_comparison():
    """Generate multi-model magnitude comparison with styled formatting."""
    ...
    # Title
    ax.set_title(
        "Vulnerability signal magnitude: multi-model comparison",
        fontsize=10,
        fontweight="normal",
    )

    # Legend matching alignment figure style
    ax.legend(fontsize=8, loc="lower left", frameon=True)

    # Grid matching alignment figure
    ...
    output_file = OUTPUT_DIR / "fig_multimodel_magnitude_comparison.pdf"
...
if __name__ == "__main__":
    print(
        "Regenerating multi-model magnitude comparison with direction_alignment.pdf style...\n"
    )
    generate_magnitude_comparison()
    print("\n✓ Done!")
