#!/usr/bin/env python3
"""
Generate direction alignment curves showing per-family breakdown for all three models.

Creates subplots for each model showing global + per-family direction alignment.
"""
...
def generate_family_alignment():
    """Generate direction alignment curves with per-family breakdown for all models."""
    ...
    for ax_idx, model in enumerate(MODELS):
        ...
        ax.set_ylabel("Per-Pair Alignment (%)" if ax_idx == 0 else "", fontsize=9)
    ...
    output_file = OUTPUT_DIR / "fig_direction_alignment_families_multimodel.pdf"
...
if __name__ == "__main__":
    print("Generating per-family direction alignment for all models...\n")
    generate_family_alignment()
    print("\n✓ Done!")
